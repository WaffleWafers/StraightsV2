...
OBJECTS = Subject.o Card.o Model.o Controller.o DeckGUI.o View.o PlayerFrame.o CardButton.o NewGameDialog.o Straights.o Player.o ComputerPlayer.o HumanPlayer.o
DEPENDS = ${OBJECTS:.o=.d}
